...
class TCN(nn.Module):
    def __init__(self, node_indim, edge_indim, xc_outdim, predict_track_params=False):
        super(TCN, self).__init__()
        self.in_w1 = IN(
            node_indim, edge_indim, node_outdim=5, edge_outdim=4, hidden_size=80
        )
        self.in_w2 = IN(5, 4, node_outdim=5, edge_outdim=4, hidden_size=80)
        self.in_c1 = IN(5, 13, node_outdim=5, edge_outdim=8, hidden_size=50)
        self.in_c2 = IN(5, 8, node_outdim=5, edge_outdim=8, hidden_size=50)
        self.in_c3 = IN(5, 8, node_outdim=5, edge_outdim=8, hidden_size=50)
        self.W = MLP(12, 1, 80)
        self.B = MLP(20, 1, 80)
