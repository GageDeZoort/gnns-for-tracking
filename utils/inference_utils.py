...
def load_pretrained_IN(indir, node_indim, edge_indim, 
                       node_outdim=3, edge_outdim=4, 
                       device='cpu', hidden_size=80):
    gnn = IN(node_indim, edge_indim,
...
def load_pretrained_TCN(indir, node_indim, edge_indim,
                        node_outdim, device='cpu'):
